...
<body>
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end gap-5">
                    <button id="buttonSidebar" type="button" class="inline-flex items-center p-2 text-sm text-white dark:text-gray-400 rounded-lg lg:hidden hover:bg-[#012e59] focus:outline-none focus:ring-2 focus:ring-gray-200 dark:hover:bg-gray-700 dark:hover:text-white">
                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                        </svg>
                    </button>
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24 gap-4">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        <button type="button" class="group flex text-s rounded-full gap-2 items-center " aria-expanded="false" data-dropdown-toggle="dropdown-user" data-dropdown-trigger="hover">
                            ...
                            <div class="font-medium hidden text-center text-white md:block">
                                Username
                            </div>
                            <svg class="iconRotate w-3 h-3 transition-all duration-500 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button id="usersButton" type="button" class="group flex justify-center items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group hover:bg-[#012e59] dark:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700 focus:bg-[#012e59]" aria-controls="dropdown-users-sidebar" data-collapse-toggle="dropdown-users-sidebar">
                        ...
                        <svg id="iconRotateUsers" class="iconRotate w-3 h-3 transition-all duration-500 hidden lg:block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        </svg>
                    </button>
                    <ul id="dropdown-users-sidebar" class="hidden lg:py-2 lg:space-y-2">
                        <li>
                            <a href="/admin/dosen" class="hidden lg:flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-[#012e59] dark:text-white dark:hover:bg-gray-700 <?= $path == '/admin/dosen' ? 'dark:bg-gray-700 bg-[#012e59]' : ''; ?>">Dosen</a>
                        </li>
                        <li>
                            <a href="/admin/mahasiswa" class="hidden lg:flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-[#012e59] dark:text-white dark:hover:bg-gray-700 <?= $path == '/admin/mahasiswa' ? 'dark:bg-gray-700 bg-[#012e59]' : ''; ?>">Mahasiswa</a>
                        </li>
                    </ul>
                    <ul id="dropdown-users-sidebar-tablet" class="hidden top-[220px] -right-[100px] absolute z-[999999] bg-gray-600 text-white flex flex-col justify-center items-center rounded-md overflow-hidden">
                        <a href="/admin/dosen" class="flex items-center w-full p-2 text-white transition duration-75  group hover:bg-[#012e59] dark:text-white dark:hover:bg-gray-700 <?= $path == '/admin/dosen' ? 'dark:bg-gray-700 bg-[#012e59]' : ''; ?>">Dosen</a>
                        <a href="/admin/mahasiswa" class="flex items-center w-full p-2 text-white transition duration-75  group hover:bg-[#012e59] dark:text-white dark:hover:bg-gray-700 <?= $path == '/admin/mahasiswa' ? 'dark:bg-gray-700 bg-[#012e59]' : ''; ?>">Mahasiswa</a>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="/admin/report" class="flex justify-center items-center p-2 py-4 lg:py-2 text-white rounded-lg dark:text-white hover:bg-[#012e59] dark:hover:bg-gray-700 group <?= $path == '/admin/report' ? 'dark:bg-gray-700 bg-[#012e59]' : ''; ?>">
    ...
    <script>
        ...
        const iconRotateUsers = document.querySelector("#iconRotateUsers");
        ...
        buttonSidebar.addEventListener("click", () => {
            ...
            iconRotateUsers.classList.toggle("hidden");
