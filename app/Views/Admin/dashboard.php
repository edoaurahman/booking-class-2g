    ...
    <div class="p-4 mt-14">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            <div
                ...
                <div class="w-full flex justify-between px-10 py-4 items-center gap-5">
                    <div class="text-left block text-white">
                        <h1 class="text-4xl font-semibold mb-2"><?= $data['totAvailable'] ?></h1>
            ...
            <div
                ...
                <div class="w-full flex justify-between px-10 py-4 items-center gap-5">
                    <div class="text-left block text-white">
                        <h1 class="text-4xl font-semibold mb-2"><?= $data['totUsed'] ?></h1>
            ...
            <div
                ...
                <div class="w-full flex justify-between px-10 py-4 items-center gap-5">
                    <div class="text-left block text-white">
                        <h1 class="text-4xl font-semibold mb-2"><?= $data['totDone'] ?></h1>
            ...
            <div
                ...
                <div class="w-full flex justify-between px-10 py-4 items-center gap-5">
                    <div class="text-left block text-white">
                        <h1 class="text-4xl font-semibold mb-2"><?= $data['totUnavailable'] ?></h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4 mt-9">
            <div x-data=""
                class="lg:col-span-2 max-h-[503px] flex flex-col h-full shadow-lg rounded bg-gray-50 dark:bg-gray-800 px-3">
                <div class="flex w-full justify-between">
                    <!-- <div class="p-5 flex flex-col gap-1 text-left text-gray-900  dark:text-white ">
                        <div class="text-xl font-semibold ">Statistik Perbandingan Jam</div>
                        <div class="text-xs font-normal text-slate-400">Perbandingan jam yang terpakai dan tidak
                            terpakai pada semua ruang</div>
                    </div>
                ...
                <div class="p-4 w-full h-[490px]">
                    <canvas id="timeChart"></canvas> -->

                </div>

            </div>
            <div x-data="tableData1" x-init="dataFetchForTopBooked()"
                        ...
                        <tbody>
                            <template x-for="item in tableData1">
                                <tr class=" border-b dark:border-gray-700">
                                    ...
                                    <td x-text="item.nama_ruang" class="px-6 py-4"></td>
                                    <td x-text="item.persentase" class="px-6 py-4"></td>
                                </tr>
                            </template>
                        </tbody>
                    </table>
        ...
        <div class="mt-4 mb-4 grid grid-rows-2 grid-cols-2 lg:grid-cols-3 lg:grid-rows-3 gap-4 max-h-[810px]">
                ...
                <div class="flex w-full justify-center items-center text-black dark:text-white gap-6 lg:pb-6">
                    <div class="flex py-4 gap-4 items-center">
                        ...
                        <div class="flex flex-col text-left">
                            <div class="lg:text-5xl text-2xl font-semibold"><?= $data['totalDosen'] ?></div>
                    ...
                    <div class="flex py-4 gap-4 items-center">
                        ...
                        <div class="flex flex-col text-left">
                            <div class="lg:text-4xl text-2xl font-semibold"><?= $data['totalMahasiswa'] ?></div>
            ...
            <div
                ...
                <div class="flex flex-wrap justify-center lg:flex-nowrap lg:justify-between p-3 gap-7 lg:gap-2">
                    <div class="flex flex-col text-center">
                        ...
                        <div class="text-2xl font-semibold text-black dark:text-white"><?= $data['totRTeori'] ?></div>
                    </div>
                    <div class="flex flex-col text-center">
                        <div class="flex items-center gap-2">
                        ...
                        <div class="text-2xl font-semibold text-black dark:text-white"><?= $data['totRPraktik'] ?></div>
                    </div>
                    <div class="flex flex-col text-center">
                        <div class="flex items-center gap-2">
                        ...
                        <div class="text-2xl font-semibold text-black dark:text-white"><?= $data['totRCampuran'] ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div x-data="dataUseCalendar" class=" flex lg:flex-col rounded-md col-span-2 lg:row-span-3 lg:col-start-2 bg-gray-50 shadow-lg
                ...
                <!-- Newest Booking -->
                <div x-data="tableData2" x-init="dataFetchForNewBook()"
...
function setDay(day) {
    const tanggal = day + '-' + currMonth + '-' + currYear;
    console.log(tanggal);
}

function getBookingNow() {
    const tanggal = day + '-' + currMonth + '-' + currYear;
    const formData = new FormData();
    formData.append('tanggal', tanggal);
    fetch('/api/booking/now', {
        method: 'POST',
        body: formData
