                    ...
                    <div class="col-span-1 w-full m-3 md:ml-12 md:mr-12 sm:pr-24">
                        <div class="mb-5 relative">
                            ...
                            <div class="text-sm font-medium text-gray-900 dark:text-white pr-6">
                                <input id="id_dosen" list="listDosen" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="id_dosen" placeholder="">
                        ...
                        <div class="mb-5 -mt-1 pr-6">
                            ...
                            <input type="text" id="dosen-pengajar" value="<?= empty($bookingAvailability) ? 'Tidak ada dosen' : $bookingAvailability['nama'] ?>" <?= empty($bookingAvailability) ? 'disabled' : 'readonly' ?> class="bg-gray-50 border mt-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div class="pr-6">
                            <label class="block  mb-2 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Upload file</label>
                            <input name="lampiran" class=" cursor-pointer mb-5  dark:text-gray-400 focus:outline-none  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500" aria-describedby="user_avatar_help" id="user_avatar" type="file">
                        ...
                        <input type="hidden" name="status" value="<?= $level == 'mahasiswa' ? 'waiting_dosen_verification' : 'onprocess' ?>">
...
<script src="/assets/js/formulir-checkout.js"></script>