        ...
        <div class="w-full">
            ...
            <div class="container py-3 mx-auto ">
                <div class="grid grid-cols-1 sm:grid-cols-8 sm:gap-4 sm:mb-11">
                    ...
                    <!-- Colom 1 -->
                    <!-- ###################### -->
                    <div class=" top-24 p-3 col-span-6 font-sans">
                        ...
                        <div class="deskripsi">
                            ...
                            <div id="hs-show-hide-collapse-heading" class="hs-collapse hidden w-full overflow-hidden transition-[height] duration-300" aria-labelledby="hs-show-hide-collapse">
                                <ul class="pl-5 pt-4">
                                    <li class="my-auto leading-7"><i class="fa-solid fa-circle-chevron-right "></i><span class="ml-3 text-sm font-normal capitalize my-auto">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</span></li>
                                    <li class="my-auto leading-7"><i class="fa-solid fa-circle-chevron-right "></i><span class="ml-3 text-sm font-normal capitalize my-auto">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</span></li>
                                    <li class="my-auto leading-7"><i class="fa-solid fa-circle-chevron-right "></i><span class="ml-3 text-sm font-normal capitalize my-auto">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</span></li>
                                </ul>

                                <p class="pt-4">consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                            </div>
                            <p class="mt-2">
                                <button onclick="transitionButton()" type="button" class="hs-collapse-toggle inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" id="hs-show-hide-collapse" data-hs-collapse="#hs-show-hide-collapse-heading">
                        ...
                        <div class="kelas mt-7">
                            <div class="judul">
                                <h2 class="font-sans font-bold text-md uppercase text-gray-600">Informasi Jam</h2>
                            </div>
                        </div>
                        <!-- slide start -->
                        <div id="controls-carousel" class="relative w-full mt-" data-carousel="static">
                            <!-- Carousel wrapper -->
                            <div class="relative  overflow-hidden h-52 rounded-lg md:h-52">
                                <!-- Item 1 -->
                                <div class=" duration-700 ease-in-out text-center bg-white p-4" data-carousel-item="active">
                                    <div id="tanggalSekarang" class=" font-sans text-base font-bold uppercase"></div>
                            ...
                            <button type="button" class="absolute top-2 start-0 z-30 flex items-start justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                            ...
                            <button type="button" class="absolute top-2 end-0 z-30 flex items-start justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
                                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                    <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                    ...
                    <!-- Colom 2 -->
                    <!-- ###################### -->
                    <div class=" col-span-2 font-sans ">
                        <div class="block text-center font-semibold text-sm border p-5 mb-10 text-gray-600">
