...
<head>
    ...
    <title><?= $level == 'admin' ? 'Admin Login' : 'Login' ?></title>
...
<body>
    <div class="flex justify-center h-screen overflow-hidden">
        ...
        <img class="w-1/2 hidden sm:block object-cover opacity-40 bg-no-repeat blur-sm" src="/assets/img/grapol.jpeg" alt="" srcset="">
