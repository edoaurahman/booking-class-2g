...
<div x-data="listRuang" class="dark:bg-dark_grey1 min-h-screen">
    <div class="container py-3 mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-8 sm:gap-4 lg:mb-11">
            ...
            <!-- Filter -->
            <!-- ################ -->
            <div class="hidden lg:block mt-5 p-3 lg:col-span-2 ">
                <div class="sticky top-20 border-2 dark:border-dark_grey2  rounded-md p-3">
                    ...
                    <div class="filter pt-5 ">
                        <div class="">
                            ...
                            <div x-data="{ open: false }" class="p-3  border rounded-md mt-4 dark:border-dark_grey2">
                                ...
                                <div x-show="open" @click.outside="open = false" id="pilihJam" class="z-10 w-full bg-white divide-y divide-gray-100 rounded-b-lg shadow p-5 dark:bg-gray-700">
                                    ...
                                    <button @click="fetchResults" type="button" id="set-max-button" class="px-3 py-2 mt-5 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <i class="fa-solid fa-clock-rotate-left mr-2  dark:text-white"></i>
                                        semua
                                    </button>
                                    <p id="helper-text-explanation" class="mt-5 text-[15px] text-gray-500 dark:text-gray-300">
                        ...
                        <div class="border p-3 rounded-md mt-4 dark:border-dark_grey2  ">
                            <!-- Dropdown menu -->
                            <div class="divide-y divide-gray-100 rounded shadow bg-bingu dark:bg-dark_grey5  dark:divide-gray-400 p-3">
                                ...
                                <div class="space-y-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownToggleButton">
                                    <template x-for="(jenis, index) in jenisRuangOptions" :key="index">
                                        <div class="flex p-2 group rounded hover:bg-gray-100 dark:hover:bg-bingu_hover">
                                            <label class="relative inline-flex items-center w-full cursor-pointer ">
                                                <input type="checkbox" :id="'jenis-ruang-' + index" :value="jenisRuangValue[index]" @click="checkSelectedJenisRuang($event)" class="sr-only peer" />
                                                ...
                                                <span x-text="jenisRuangOptions[index]" class="ms-3 text-sm font-medium text-white group-hover:text-bingu_hover dark:group-hover:text-white dark:text-gray-300">Ruang Teori</span>
                                            </label>
                                        </div>
                                    </template>
                        ...
                        <div class="p-3">
                            <button @click="resetFilter" type="button" class="text-white w-full bg-gradient-to-r from-blue-500 to-bingu hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Hapus Filter</button>
                        </div>
                        <!-- === Filter Jenis END === -->
                    </div>
                </div>
            ...
            <div class="col-span-6 font-sans w-[70%] md:max-w-3xl lg:w-full mx-auto">
                <div class="py-5 mt-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="search-ruang" @input.debounce.750="fetchResults" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Nama Ruang ..." required>
                        <button type="submit" @click="fetchResults" class="text-white absolute end-2.5 bottom-2.5 bg-bingu hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                    </div>
                </div>
                <div x-show="isLoading" class="col-span-6 font-sans w-full">
                    <div class="flex items-center justify-center w-full h-screen bg-transparent dark:bg-gray-800 dark:border-gray-700">
                        <div role="status">
        ...
        <div class="lg:hidden flex justify-end z-50 fixed text-white right-4 bottom-2">
        ...
        <div id="drawer-navigation" class="lg:hidden block fixed top-0 left-0 z-50 h-screen p-4 overflow-y-auto transition-transform -translate-x-full w-72 bg-white  dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
            <!-- title start -->
                ...
                <div class="space-y-2 font-medium">
                    <div class="filter pt-5 ">
                        <div class="">
                            ...
                            <div class=" p-3 border rounded-md dark:border-dark_grey2">
                                <label for="tanggal" class="block text-gray-900 dark:text-white font-sans text-sm font-medium mb-2">Pilih Tanggal</label>
                                <input @input.debounce="fetchResults" type="date" id="tanggal-sidebar" class="appearance-none border border-gray-400 dark:border-dark_grey3 rounded w-full py-3 px-4 text-gray-700 dark:bg-dark_grey3 dark:text-dark_grey2 font-sans text-sm leading-6 transform-none" />
                            </div>
                            <!-- === Filter Tanggal END ===-->
                            ...
                            <div x-data="{ open: false }" class="p-3  border rounded-md mt-4 dark:border-dark_grey2">
                                <form>
                                    ...
                                    <div x-show="open" @click.outside="open = false" class="z-10 w-full bg-white divide-y divide-gray-100 rounded-b-lg shadow p-5 dark:bg-gray-700">
                                        ...
                                        <button @click.debounce="fetchResults" type="button" id="set-max-button-sidebar" class="px-3 py-2 mt-5 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <i class="fa-solid fa-clock-rotate-left mr-2  dark:text-white"></i>
                                            semua
                                        </button>
                        ...
                        <div class=" border p-3 rounded-md mt-4 dark:border-dark_grey2  ">
                            ...
                            <div class=" divide-y divide-gray-100 rounded shadow bg-bingu dark:bg-dark_grey5  dark:divide-gray-400 p-3">
                                ...
                                <div class="space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownToggleButton">
                                    <template x-for="(jenis, index) in jenisRuangOptions" :key="index">
                                        <div class="flex p-2 group rounded hover:bg-gray-100 dark:hover:bg-bingu_hover">
                                            <label class="relative inline-flex items-center w-full cursor-pointer ">
                                                <input type="checkbox" :value="jenisRuangValue[index]" @click="checkSelectedJenisRuang($event)" class="sr-only peer" />
                                                <div class="w-9 h-5 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full rtl:peer-checked:after:translate-x-[-100%] peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-500 peer-checked:bg-blue-600"></div>
                                                <span x-text="jenisRuangOptions[index]" class="ms-3 text-sm font-medium text-white group-hover:text-bingu_hover dark:group-hover:text-white dark:text-gray-300">Ruang Teori</span>
                                            </label>
                                        </div>
